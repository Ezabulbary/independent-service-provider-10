...
import Image from '../../images/about/aboutus.png';

const About = () => {
    return (
        <div className='container'>
            <div className='d-md-flex align-items-center my-md-5'>
                <div>
                    <img className='img-sm-fluid mx-auto d-block  mt-3' src={Image} alt="" />
                </div>
                <div className='p-5'>
